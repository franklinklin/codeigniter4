...
<body>
    ...
    <div class="container mt-3">
        ...
        <?php echo anchor(base_url($form.'/create'),'Novo Cliente',['class'=>'btn btn-success mb-3'])?>
                ...
                <?php foreach($clients as $client):?>
                    <tr>
                        ...
                        <td>
                            ...
                            -
                            <?php echo anchor('client/delete/'.$client['id'], '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M4 8h16v13a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V8zm3-3V3a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v2h5v2H2V5h5zm2-1v1h6V4H9zm0 8v6h2v-6H9zm4 0v6h2v-6h-2z"/></svg>',['onclick'=>'return confirma()'])?>
                        </td>
                    </tr> 
                <?php endforeach;?>
            <?php }?>
